				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/TamaSoft.png')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/TamaSoft.png')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/TamaSoft.png')}}" class="dark-logo-2" alt="logo"></a>
						</div>

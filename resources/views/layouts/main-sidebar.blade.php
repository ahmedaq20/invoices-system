<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/TamaSoft.png')}}" class="main-logo" alt="logo"></a>
				...
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/TamaSoft.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
				...
				<ul class="side-menu">
					...
					<li class="slide">
                        ...
                        <ul class="slide-menu">
                          ...
                          <li><a class="slide-item" href="{{route('invoices.invoicesPaid')}}"> الفواتير المدفوعة</a></li>
                          @endcan


                          @can('الفواتير الغير مدفوعة')
                          <li><a class="slide-item" href="{{ url('/' . $page='invoicesUnpaid') }}"> الفواتير غير المدفوعة</a></li>
                          @endcan
                          @can( 'الفواتير المدفوعة جزئيا')
                          <li><a class="slide-item" href="{{ url('/' . $page='invoicesPaidPartiel') }}">الفواتير المدفوعة جزئين</a></li>
                          @endcan
                          @can('ارشيف الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='ReportInovice') }}">تقرير الفواتير</a></li>
                            @endcan
                            @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . $page='CustomersInovice') }}">تقرير العملاء</a></li>
                            @endcan
						</ul>
                        @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المتسخدمين</a></li>
                            @endcan
